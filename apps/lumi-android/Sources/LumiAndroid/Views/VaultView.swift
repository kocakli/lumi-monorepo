...
// VaultMoment lives in Models/VaultMoment.swift (extracted so VaultViewModel
// can compile without this view present).
...
struct ZenGlassCardModifier: ViewModifier {
