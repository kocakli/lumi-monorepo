...
final class PairingViewModel: ObservableObject {
    ...
    // Swift 6 strict-concurrency mode. ListenerRegistration is non-Sendable
    // but in practice these are written exactly once on the main actor and
    // only released from the deinit path — no concurrent access.
