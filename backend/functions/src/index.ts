      ...
      try {
        ...
        if (targetToken) {
          await messaging.send({
            ...
            apns: { payload: { aps: { sound: "lumi-notification.caf", category: "lumi.message", "mutable-content": 1 } } },
          });
        }
      } catch (error) {
    ...
    for (const userDoc of usersSnap.docs) {
      ...
      try {
        await messaging.send({
          ...
          apns: {
            payload: {
              aps: { sound: "lumi-notification.caf", category: "lumi.message", "mutable-content": 1 },
            },
          },
        });
